...
import { Button, Form, Input, Row, Col, Space, Table, Select, Tooltip, Modal, message, Tag, Typography , Alert} from 'antd';
...
const LyDoPending = () => {
  ...
  return (
    <>
      ...
      <Modal open={isModalOpen} maskClosable={true} onOk={handleOk} onCancel={handleCancel} okText='Lưu lại' title='Thêm mới lý do từ chối cập nhật'>
        <Row gutter={[16,16]}>
          <Col span={24}>
            <Alert
