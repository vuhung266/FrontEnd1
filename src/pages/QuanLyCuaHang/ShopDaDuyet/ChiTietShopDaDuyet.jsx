    ...
    const data = [
        {
            ...
            noidung: 'Duyệt cửa hàng [Tên cửa hàng]',
        },
        {
            key: '2',
            STT: '2',
            ...
            <Row gutter={[16, 32]}>
                        ...
                        <Row>
                            <Col span={12}>
                                <Form {...formItemLayout}>
                                    ...
                                    <Form.Item className="form-item-custom" label="Ngày duyệt:">
                ...
                <Col span={24}>
                    ...
                    >
                        ...
                        <Button icon={<HistoryOutlined />} type="primary" danger size="large">
                            Yêu cầu duyệt lại
                        </Button>
                    </Space>
                </Col>
...
export default ChiTietShopDaDuyet;
